...
model.load_state_dict(torch.load('sudoku_diffusion_gidd_500k.pth', map_location=device))
print(f"Loaded checkpoint.")

# freeze holding head — it has converged, train jump chain only
model.holding.requires_grad_(False)
